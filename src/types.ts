...
// The pure (React-free) types live in coreTypes.ts so they can be consumed
// through the `core` entry point. They are re-exported here so imports from
// the package root keep working unchanged.
export type {
  ExpressionError,
  ExpressionErrorCode,
  OperatorKind,
